        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Total por categoria - Anual</h3>
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tbody>
                   @foreach ($total_por_categoria_anual as $categorias_anual)
                  
                  <tr>
                      <td>{{ $categorias_anual[0]}}</td>
                      <td>{{ $categorias_anual[2017]}} </td>
                      <td>{{ $categorias_anual[2018]}} </td>
                  </tr>
